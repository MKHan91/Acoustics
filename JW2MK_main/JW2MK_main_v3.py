from MK_version.JW2MK_dataloader.JW2MK_dataloader_v3 import *
from MK_version.JW2MK_model.JW2MK_model_v3 import *
...
parser.add_argument('--main_name',          type=str,       help='current main file name', default='20190603_JW2MK_mainV3_M3')
...
#                      'Loss': K.eval(self.model.loss),
#                      'Accuracy': K.eval(self.model.acc),
#                      'validation accuracy': K.eval(self.model.val_acc)})
...
def train(params):
    resnet_model50 = resnet50()
    tb_callback = TensorBoardHistory(log_dir=os.path.join(params.base_path, 'JW_will', 'MK_version', 'Tensorboard', params.main_name))
    ...
    resnet_model50.fit_generator(generator=train_generator, steps_per_epoch=len(train_generator),
                                 ...
                                 callbacks=[tb_callback, tensorboard, checkpoint_callback], workers=params.num_threads)
